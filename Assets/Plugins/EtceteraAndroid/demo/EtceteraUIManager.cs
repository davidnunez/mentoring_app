...
public class EtceteraUIManager : MonoBehaviourGUI
{
	...
	void OnGUI()
	{
		...
		if( GUILayout.Button( "Play Video" + Application.persistentDataPath ) )
		{
			...
			EtceteraAndroid.playMovie( "/sdcard/Movies/TINGA_TINGA_2-5.mp4", 0xFF0000, false, EtceteraAndroid.ScalingMode.AspectFit, true );
		}
